...
func (s *FluentModifierContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.EnterFluentModifier(s)
	}
}

func (s *FluentModifierContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.ExitFluentModifier(s)
	}
}
...
func (s *CodeComparatorContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.EnterCodeComparator(s)
	}
}

func (s *CodeComparatorContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.ExitCodeComparator(s)
	}
}
...
func (s *StartingClauseContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.EnterStartingClause(s)
	}
}

func (s *StartingClauseContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.ExitStartingClause(s)
	}
}
...
func (s *SimpleNumberLiteralContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.EnterSimpleNumberLiteral(s)
	}
}

func (s *SimpleNumberLiteralContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.ExitSimpleNumberLiteral(s)
	}
}
...
func (s *SimpleStringLiteralContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.EnterSimpleStringLiteral(s)
	}
}

func (s *SimpleStringLiteralContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(cqlListener); ok {
		listenerT.ExitSimpleStringLiteral(s)
	}
}
